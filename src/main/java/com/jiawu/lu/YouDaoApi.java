...
public class YouDaoApi {
    ...
    public static String translate(String query) {
        ...
        String to = "EN";
        String from = "zh-CHS";
        String sign = md5(appKey + query + salt + "vPsdGcERUmcRH3r5OObI10mY7jvopAHk");
        ...
        try {
            ...
            String response = requestForHttp("https://openapi.youdao.com/api", params);
            return JSON.parseObject(response).getJSONArray("translation").getString(0);
        } catch (Exception e) {
            e.printStackTrace();
            return query;
        }
